...
public class Deer extends Herbivore {
    ...
    // Вес
    private final double weight = 170;
    // мах кол-во животных на одной клетке
    private final int maxCountThisAnimalTypeToCell = 41;
    ...
    private final double maxSatiety = 26;
    ...
    @Override
    public void eat() {
        int countThisAnimalTypeToCell = currentCellMap.get("Олень");
        ...
        if (deadFlag || (countThisAnimalTypeToCell < maxCountThisAnimalTypeToCell)) {
            die(locationLength, locationWidth, "Олень");
            return;
        }
    ...
    public void reproduction() {
        ...
        if (currentCellMap.get("Олень") > 1) {
            ...
            if (countThisAnimalTypeToCell < maxCountThisAnimalTypeToCell) {
                ...
                for (int i = 0; i < details.randomizer(kidMinCount, kidMaxCount); i++) {
                    new Deer().firstBorn(locationLength, locationWidth);
                }
                return;
            }
        }
        ...
        move(locationLength, locationWidth, speed, "Олень");
    }
