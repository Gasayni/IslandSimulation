...
public class Cow extends Animal {
    ...
    // Вес
    private final double weight = 350;
    // мах кол-во животных на одной клетке
    private final int maxCountThisAnimalTypeToCell = 20;
    ...
    private final double maxSatiety = 53;
    ...
    @Override
    public void eat() {
        int countThisAnimalTypeToCell = currentCellMap.get("Корова");
        ...
        if (deadFlag || (countThisAnimalTypeToCell < maxCountThisAnimalTypeToCell)) {
            die(locationLength, locationWidth, "Корова");
            return;
        }
    ...
    public void reproduction() {
        ...
        if (currentCellMap.get("Корова") > 1) {
            ...
            if (countThisAnimalTypeToCell < maxCountThisAnimalTypeToCell) {
                ...
                for (int i = 0; i < details.randomizer(kidMinCount, kidMaxCount); i++) {
                    new Cow().firstBorn(locationLength, locationWidth);
                }
                return;
            }
        }
        ...
        move(locationLength, locationWidth, speed, "Корова");
    }
