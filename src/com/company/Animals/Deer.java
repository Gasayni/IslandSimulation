...
public class Deer extends Animal {
    ...
    private static final double maxSatiety = 26;
    ...
    private final int countThisAnimalTypeToCell = cell.deerListToCell.size();
    ...
    public void born(int locationLength, int locationWidth) {
        ...
        cells[locationLength][locationWidth].deerListToCell.add(new Deer());
    }

    @Override
    public void die(int locationLength, int locationWidth) {
        // то просто уменьшаем на 1
        cells[locationLength][locationWidth].deerListToCell.remove(this);
    }
